import { BOLSTERING } from "../src/queries/events/affixes/bolstering";
import { PF } from "../src/queries/events/dungeons/pf";
import { SD_LANTERN_BUFF } from "../src/queries/events/dungeons/sd";
import { TOP_BANNER_AURA } from "../src/queries/events/dungeons/top";
import { INVISIBILITY } from "../src/queries/events/other";
import type { ApplyBuffEvent } from "../src/queries/events/types";
import { applyBuffProcessor } from "../src/transform/events/applybuff";
