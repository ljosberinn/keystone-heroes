...
export const reportHandlerError = {
  ...
  BROKEN_LOG_OR_WCL_UNAVAILABLE:
    "This report is either broken or the request to Warcraft Logs failed. Please try again at a later time.",
  ...
  PRIVATE_REPORT:
    "This report is private and cannot be retrieved via API. Please set it to public or ask the owner to do so. Then retry after 5 minutes.",
} as const;
...
export const fightHandlerError = {
  ...
  PRIVATE_REPORT: reportHandlerError.PRIVATE_REPORT,
  MISSING_DUNGEON:
