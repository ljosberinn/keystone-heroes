...
export type AntiPersonnelSquirrelDamageRowProps = {
...
const ability = spells[WS.ANTI_PERSONNEL_SQUIRREL];

// eslint-disable-next-line import/no-default-export
export default function AntiPersonnelSquirrelDamageRow({
  events,
}: AntiPersonnelSquirrelDamageRowProps): JSX.Element {
