...
export type AnimaExhaustDamageRowProps = {
...
const ability = spells[NW.KYRIAN_ORB_DAMAGE];

// eslint-disable-next-line import/no-default-export
export default function AnimaExhaustDamageRow({
  events,
}: AnimaExhaustDamageRowProps): JSX.Element {
