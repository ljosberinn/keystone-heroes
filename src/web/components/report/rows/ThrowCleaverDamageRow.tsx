...
export type ThrowCleaverDamageRowProps = {
...
const ability = spells[NW.THROW_CLEAVER];

// eslint-disable-next-line import/no-default-export
export default function ThrowCleaverDamageRow({
  events,
}: ThrowCleaverDamageRowProps): JSX.Element {
