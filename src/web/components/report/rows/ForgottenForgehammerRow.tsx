...
export type ForgottenForgehammerRowProps = {
...
const ability = spells[NW.HAMMER];

// eslint-disable-next-line import/no-default-export
export default function ForgottenForgehammerRow({
  events,
}: ForgottenForgehammerRowProps): JSX.Element {
