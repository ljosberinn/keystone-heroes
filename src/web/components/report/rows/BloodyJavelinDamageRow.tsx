...
export type BloodyJavelinDamageRowProps = {
...
const ability = spells[NW.SPEAR];

// eslint-disable-next-line import/no-default-export
export default function BloodyJavelinDamageRow({
  events,
}: BloodyJavelinDamageRowProps): JSX.Element {
